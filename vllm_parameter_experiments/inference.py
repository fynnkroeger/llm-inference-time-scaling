...
def run_generation_vllm(out_file, sampling_params, llm_params):
    ...
    if not force_generation:
        for file_name, config in experiments.items():
            if (
                ...
                return file_name
    print("running experiment", sampling_params, llm_params)
...
if __name__ == "__main__":
    ...
    run_experiment(sampling_params, llm_params)
